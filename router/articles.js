...
router.get("/moderation", authAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const getArticles = yield Articles.find({ status: "moderation" }).sort({ published: -1 });
...
router.post("/create-by-admin", authAdmin, upload.single('img'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const article = new Articles({
            ...
            full_text,
            status: "approved",
            img: req.file ? req.file.path : "/img/no-image.jpg"
        });
...
router.post("/create-by-user", upload.single('img'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const title = req.body.title;
        const anons = req.body.anons;
        const full_text = req.body.full_text;
